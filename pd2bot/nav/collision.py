...
the struct is deliberately absent from BH, see there.
    ...
    python -m pd2bot.nav.collision          ASCII dump around the player
    python -m pd2bot.nav.collision --size 40   wider view (subtiles per side)
"""
...
def main(argv: list[str] | None = None) -> int:
    ...
    if not local.rooms:
        ...
        print(
            ...
            "Run `python -m pd2bot.nav.collision --debug` to see which step of the "
